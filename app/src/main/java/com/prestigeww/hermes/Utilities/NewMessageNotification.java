...
public class NewMessageNotification {
     ...
     * @see #cancel(Context)
     */
    public  void notify(final Context context, String chatname,
                               String exampleString, int number) {
         ...
         NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentIntent(
                        PendingIntent.getActivity(
                                context,
                                0,
                                new Intent(context, ChatThreadFeedActivity.class),
